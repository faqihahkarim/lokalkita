...
input_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\review_cleaned_translated_1.csv"

# Final output file
output_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\review_clean_final.csv"
