...
input_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\review_clean_final.csv"

# Output file name
output_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\review_weighted_scores.csv"
