...
# where to save SBERT embeddings (so you don't recompute every time)
embeddings_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\metadata\metadata_sbert_embeddings.npy"

# where to save scoring results
output_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\metadata\metadata_sbert_scores.csv"
