...
output_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\metadata\metadata_tfidf_scores.csv"
...
vectorizer = TfidfVectorizer(
    stop_words="english",
    max_features=5000  # optional, prevents overfitting
)
...
example_query = "cultural art gallery with modern exhibits and a cafe"
