...
input_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\raw data\raw_review_latest_1.xlsx"
checkpoint_path = r"C:\laragon\www\web\lokalkita\data\latest(231125)\clean data\review_cleaned.csv"
...
if os.path.exists(checkpoint_path):
    ...
    if "translated_review" in df_checkpoint.columns:
        ...
        print("⚠️ Checkpoint missing translated_review column. Starting fresh.")
...
for i in range(total):
    ...
    try:
        ...
        print(f"⚠️ Translation error at row {i}: {e}")
